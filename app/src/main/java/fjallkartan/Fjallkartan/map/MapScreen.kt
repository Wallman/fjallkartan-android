...
private fun MapLibreView(
    ...
    val mapView = remember {
        MapView(context).also {
            it.onCreate(Bundle())
            holder.attach(it, onCameraChanged)
        }
    }
...
private class MapHolder {
    ...
    fun attach(mapView: MapView, onCameraChanged: (CameraPosition) -> Unit) {
        ...
        mapView.getMapAsync { readyMap ->
            ...
            readyMap.cameraPosition = CameraPosition.Builder()
                ...
                .zoom(3.4)
                .build()
            readyMap.addOnCameraMoveListener { onCameraChanged(readyMap.cameraPosition) }
